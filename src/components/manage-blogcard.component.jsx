  ...
  return (
    <>
      <div className="flex gap-10 border-b mb-6 max-md:px-4 border-grey pb-6 items-center ">
        ...
        />
        <div className="flex flex-col justify-between py-2 w-full mim-w-[300px]">
          <div>
            <Link
              to={`/blog/${blog_id}`}
          ...
          <div className="flex gap-6 mt-3">
            ...
            <button
              ...
              className="pr-4 py-2 underline md:hidden"
            >
              Stats{" "}
            </button>
            <button
...
const BlogStat = ({ stats }) => {
  return (
    <div className="flex gap-2 max-lg:mb-6 max-lg:pb-6 max-lg:border-b border-grey">
  ...
  return (
    <div className="flex gap-5 lg:gap-10 pb-6 border-grey">
      ...
      <div>
        ...
        <p className="font-gelasio line-clamp-2">
